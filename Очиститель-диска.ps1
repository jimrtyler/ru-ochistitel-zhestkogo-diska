...
#GUI Variables
$FormTitleText = "Очиститель диска Джима Тайлера (PowerShellEngineer.com)"
$SelectDiskLabelText = "Выберите диск:"
$FreeSpaceLabelText = "Свободное пространство (гигабайт): "
$TotalSpaceLabelText = "Общее пространство (гигабайты): "
$JunkFoundLabelText = "Обнаружен мусор (гигабайт):"
$CleanDiskBtnText = "Очистить диск *Удалить файлы*"
$SpaceCleanedLabelText = "Очищено пространство (гигабайт): "
$LogFileLabelText = "Найден файл журнала: $abcdefg"
$CreditLabelText = "Сценарий Джима Тайлера - PowerShellEngineer.com"
$LogFileLocatedText = "Найден файл журнала"
$AnalyzingDriveText = "Анализ дисков..."
$BrowsersAreRunningText = "Браузеры запущены... Уведомить пользователя..."
$PleaseCloseBrowsersText = "Пожалуйста, закройте все веб-браузеры и повторите попытку."
$CleaningDriveText = "Очистка диска..."
